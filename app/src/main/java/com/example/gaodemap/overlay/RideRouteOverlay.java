...
/**
 * 骑行路线图层,在高德地图API里，如果要显示骑行路线规划，可以用此类来创建骑行路线图层。如不满足需求，也可以自己创建自定义的骑行路线图层。
 */
public class RideRouteOverlay extends RouteOverlay {
     ...
     * @param aMap     地图对象。
     * @param ridePath 骑行路线规划的一个方案。详见搜索服务模块的路径查询包（com.amap.api.services.route）中的类
     ...
     *                 <strong><a href="../../../../../../Search/com/amap/api/services/core/LatLonPoint.html" title="com.amap.api.services.core中的类">LatLonPoint</a></strong>。
     */
    public RideRouteOverlay(Context context, AMap aMap, RidePath ridePath, LatLonPoint start, LatLonPoint end) {
        super(context);
        this.aMap = aMap;
